...
--
-- Table structure for table `reservas_horarios`
--

DROP TABLE IF EXISTS `reservas_horarios`;
...
--
-- Dumping data for table `reservas_horarios`
--

LOCK TABLES `reservas_horarios` WRITE;
/*!40000 ALTER TABLE `reservas_horarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `reservas_horarios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-09-15 11:43:46
